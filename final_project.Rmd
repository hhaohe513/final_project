...
people with high/normal blood pressure and people with/without sleep disorder.
Then we will provide point estimates and 95% confidence intervals for the mean 
blood pressure for people with/without sleep disorder. We will also find 
points estimates and confidence intervals for the difference between these two
groups of people and check whether 0 is included in the confidence interval.
Finally, we will use a regression approach to study whether sleep disorder
is a significant factor that determine blood pressures or not.
...
trouble sleeping, feel overly sleepy for more than 15 times per month. And *= 0*
otherwise.

Codes for the data manipulation stated above can be found at 
...
2. Complete the regression approach part
3. Complete conclusion part